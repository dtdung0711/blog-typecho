...
<section id="custom-field"
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="fieldTypes[]" id="fieldtype">
                        ...
                        <option
                            value="float"<?php if ('float' == $field['type']): ?> selected<?php endif; ?>><?php _e('Số thực'); ?></option>
                        <option
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="fieldTypes[]" id="fieldtype">
                        ...
                        <option value="float"><?php _e('Số thực'); ?></option>
                    </select>
                </td>
                <td>
                    <label for="fieldvalue" class="sr-only"><?php _e('Giá trị trường'); ?></label>
    ...
    <div class="description clearfix">
        ...
        <?php _e('Trường tùy chỉnh có thể mở rộng chức năng của mẫu của bạn. Xem chi tiết cách sử dụng tại <a href="https://docs.typecho.org/help/custom-fields">tài liệu trợ giúp</a>'); ?>
    </div>
</section>
