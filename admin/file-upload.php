...
<div id="upload-panel" class="p">
    <div class="upload-area" draggable="true"><?php _e('Kéo và thả tập tin vào đây<br>hoặc %schọn tập tin để tải lên%s', '<a href="###" class="upload-file">', '</a>'); ?></div>
    <ul id="file-list">
    <?php while ($attachment->next()): ?>
        <li data-cid="<?php $attachment->cid(); ?>" data-url="<?php echo $attachment->attachment->url; ?>" data-image="<?php echo $attachment->attachment->isImage ? 1 : 0; ?>"><input type="hidden" name="attachment[]" value="<?php $attachment->cid(); ?>" />
            <a class="insert" title="<?php _e('Nhấn để chèn tập tin'); ?>" href="###"><?php $attachment->title(); ?></a>
            <div class="info">
