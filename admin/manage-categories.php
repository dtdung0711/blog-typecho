        ...
        <div class="row typecho-page-main manage-metas">
            ...
            <div class="col-mb-12" role="main">
                ...
                <form method="post" name="manage_categories" class="operate-form">
                    ...
                    <li><a lang="<?php _e('Làm mới danh mục có thể mất thời gian, bạn có chắc chắn muốn làm mới các danh mục này không?'); ?>"
                    ...
                    <th class="kit-hidden-mb"><?php _e('Tên thay thế'); ?></th>
                    <th></th>
                    <th class="kit-hidden-mb"><?php _e('Số bài viết'); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <a class="hidden-by-mouse"
                                                   ...
                                                   title="<?php _e('Thiết lập làm mặc định'); ?>"><?php _e('Mặc định'); ?></a>
                                            <?php endif; ?>
                                        </td>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6"><h6 class="typecho-list-table-title"><?php _e('Không có danh mục nào'); ?></h6>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
