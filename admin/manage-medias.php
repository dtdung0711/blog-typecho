...
<button class="btn dropdown-toggle btn-s" type="button"><i
                                ...
                                <ul class="dropdown-menu">
                                    <li><a lang="<?php _e('Bạn có chắc muốn xóa các tệp này không?'); ?>"
                                ...
                                <button class="btn btn-s btn-warn btn-operate"
                                        ...
                                        lang="<?php _e('Bạn có chắc muốn xóa các tệp không được lưu trữ không?'); ?>"><?php _e('Xóa tệp không được lưu trữ'); ?></button>
                            </div>
                        </div>
                    ...
                    <div class="typecho-table-wrap">
                        <table class="typecho-list-table draggable">
                            ...
                            <tr>
                                ...
                                <th class="kit-hidden-mb"></th>
                                <th><?php _e('Tên tệp'); ?></th>
                                <th class="kit-hidden-mb"><?php _e('Người tải lên'); ?></th>
                                <th class="kit-hidden-mb"><?php _e('Bài viết liên quan'); ?></th>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6"><h6 class="typecho-list-table-title"><?php _e('Không có tệp nào'); ?></h6>
                                    </td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
                ...
                <div class="typecho-list-operate clearfix">
                    <form method="get">
                        <div class="operate">
                            ...
                            <div class="btn-group btn-drop">
                                <button class="btn dropdown-toggle btn-s" type="button"><i
                                        class="sr-only"><?php _e('操作'); ?></i><?php _e('Các mục đã chọn'); ?> <i
                                        class="i-caret-down"></i></button>
                                <ul class="dropdown-menu">
                                    <li><a lang="<?php _e('Bạn có chắc muốn xóa các tệp này không?'); ?>"
                                           href="<?php $security->index('/action/contents-attachment-edit?do=delete'); ?>"><?php _e('Xóa'); ?></a>
