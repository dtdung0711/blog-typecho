            ...
            <div class="col-mb-12 col-tb-8" role="main">
                ...
                <div id="upload-panel" class="p">
                    <div class="upload-area"
                         draggable="true"><?php _e('Kéo và thả tập tin vào đây<br>hoặc %schọn tập tin để tải lên%s', '<a href="###" class="upload-file">', '</a>'); ?></div>
                    <ul id="file-list"></ul>
                </div>
            </div>
    ...
    $(document).ready(function () {
        ...
        function fileUploadError(error) {
            ...
            switch (code) {
                case plupload.FILE_SIZE_ERROR:
                    word = '<?php _e('Dung lượng tập tin vượt quá giới hạn'); ?>';
                    break;
                case plupload.FILE_EXTENSION_ERROR:
                    word = '<?php _e('Phần mở rộng tập tin không được hỗ trợ'); ?>';
                    break;
            ...
            var fileError = '<?php _e('%s Tải lên thất bại'); ?>'.replace('%s', file.name),
                li, exist = $('#' + file.id);
        ...
        var uploader = new plupload.Uploader({
            ...
            filters: {
                ...
                mime_types: [{
                    'title': '<?php _e('Các loại tập tin được phép'); ?>',
