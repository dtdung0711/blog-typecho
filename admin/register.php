...
<div class="typecho-login-wrap">
    <div class="typecho-login">
        ...
        <form action="<?php $options->registerAction(); ?>" method="post" name="register" role="form">
            <p>
                <label for="name" class="sr-only"><?php _e('Tên người dùng'); ?></label>
                <input type="text" id="name" name="name" placeholder="<?php _e('Tên người dùng'); ?>" value="<?php echo $rememberName; ?>" class="text-l w-100" autofocus />
            </p>
            <p>
        ...
        <p class="more-link">
            ...
            &bull;
            <a href="<?php $options->adminUrl('login.php'); ?>"><?php _e('Đăng nhập người dùng'); ?></a>
        </p>
    </div>
</div>
<?php 
