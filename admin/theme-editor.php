        ...
        <div class="row typecho-page-main" role="main">
            <div class="col-mb-12">
                <ul class="typecho-option-tabs fix-tabs clearfix">
                    <li><a href="<?php $options->adminUrl('themes.php'); ?>"><?php _e('Giao diện hiện có'); ?></a></li>
                    ...
                    <form method="post" name="theme" id="theme"
                        ...
                        <p class="typecho-option typecho-option-submit">
                            <?php if ($files->currentIsWriteable()): ?>
                                ...
                                <button type="submit" class="btn primary"><?php _e('Lưu tệp'); ?></button>
                            <?php else: ?>
                                <em><?php _e('Không thể ghi vào tệp này'); ?></em>
                            <?php endif; ?>
                        </p>
                    </form>
                </div>
