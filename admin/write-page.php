    ...
    <div class="col-mb-12 col-tb-9" role="main">
        <?php if ($page->draft): ?>
            <?php if ($page->draft['cid'] != $page->cid): ?>
                ...
                <cite class="edit-draft-notice"><?php _e('Bạn đang chỉnh sửa phiên bản nháp được lưu vào %s. Bạn có thể <a href="%s">xóa nó</a>', $pageModifyDate->word(),
        ...
        <div id="tab-advance" class="tab-content">
            ...
            <section class="typecho-post-option">
                ...
                <p><input type="text" id="order" name="order" value="<?php $page->order(); ?>"
                          class="w-100"/></p>
                <p class="description"><?php _e('Đặt một giá trị thứ tự cho trang tùy chỉnh của bạn, các trang sẽ được sắp xếp theo giá trị này từ nhỏ đến lớn'); ?></p>
            </section>
            ...
            <section class="typecho-post-option">
                ...
                <p class="description"><?php _e('Nếu bạn chọn một mẫu tùy chỉnh cho trang này, hệ thống sẽ hiển thị nó theo mẫu bạn chọn'); ?></p>
            </section>
                ...
                <section class="typecho-post-option allow-option">
                    ...
                    <ul>
                        ...
                        <li><input id="allowFeed" name="allowFeed" type="checkbox" value="1"
                            ...
                            <label for="allowFeed"><?php _e('Cho phép xuất hiện trong lưu trữ'); ?></label></li>
                    </ul>
                </section>
            ...
            <?php if ($page->have()): ?>
                ...
                <section class="typecho-post-option">
                    <p class="description">
                        ...
                        <br>
                        <?php _e('Đã cập nhật lần cuối vào %s', $modified->word()); ?>
                    </p>
                </section>
            <?php endif; ?>
        </div><!-- end #tab-advance -->
