...
<head>
  ...
  <title><?php $this->archiveTitle(array(
            'category'  =>  _t('Bài viết trong danh mục %s'),
            'search'    =>  _t('Bài viết chứa từ khóa %s'),
            'tag'       =>  _t('Bài viết dưới tag %s'),
            'author'    =>  _t('Bài viết của tác giả %s')            
  ...
  <script>
    ...
    localSearch: {
        path: undefined,
        languages: {
            hits_empty: "Nhấn Enter để tìm kiếm: ${query}"
        }
    },
    translate: {
        defaultEncoding: <?php $this->options->DefaultEncoding() ?>,
        translateDelay: 0,
        msgToTraditionalChinese: "Chuyển sang Chữ Phồn thể",
        msgToSimplifiedChinese: "Chuyển sang Chữ Tinh thể"
    },
    ...
    lightbox: "fancybox",
    Snackbar: {
        "chs_to_cht": "Bạn đã chuyển sang Chữ Phồn thể",
        "cht_to_chs": "Bạn đã chuyển sang Chữ Tinh thể",
        "day_to_night": "Bạn đã chuyển sang Chế độ Nền tối",
        "night_to_day": "Bạn đã chuyển sang Chế độ Nền sáng",
        "bgLight": "#49b1f5",
        "bgDark": "#121212",
...
<body>
  ...
  <!--[if lt IE 8]>
    <div class="browsehappy" role="dialog"><?php _e('Trang web hiện tại <strong>không hỗ trợ</strong> trình duyệt bạn đang sử dụng. Để truy cập trang web một cách bình thường, vui lòng <a href="http://browsehappy.com/">nâng cấp trình duyệt của bạn</a>'); ?>.</div>
<![endif]-->
    ...
    <div id="sidebar-menus" class="">
      ...
      <div class="menus_items">
        <div class="menus_item">
          <a class="site-page" href="<?php $this->options->siteUrl(); ?>"><i class="fa-fw fas fa-home"></i><span>Trang chủ</span></a>
        </div>
