  ...
  <div id="post">
    ...
    <article class="post-content" id="article-container">
      ...
      if ($this->user->hasLogin() || $result) {
        ...
        $content = preg_replace("/\[hide\](.*?)\[\/hide\]/sm", '<p class="need-reply">Nội dung ở đây <a href="#comments">Trả lời</a> để xem</p>', $this->content);
      }
      echo $content;
      ?>
    </article>
    ...
    <div class="post-copyright__author">
        <span class="post-copyright-meta">Tác giả: </span>
        <span class="copyright-info">
            <a itemprop="name" href="<?php $this->author->permalink(); ?>" rel="author"><?php $this->author(); ?></a>
        </span>
    </div>
    <div class="post-copyright__type">
        <span class="post-copyright-meta">Liên kết bài viết: </span>
        <span class="copyright-info">
    ...
    <div class="copyright-notice">
        <?php if ($this->fields->CopyRight == 'off') : ?>
            <span style="color:red">Bài viết này cấm sao chép</span>, vui lòng liên hệ tác giả trước khi trích dẫn hoặc sao chép nội dung!
        <?php else : ?>
            Tất cả các bài viết trên blog này, trừ khi có ghi chú đặc biệt, đều sử dụng giấy phép
            <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank">CC BY-NC-SA 4.0</a>.
            Vui lòng ghi rõ nguồn từ <a href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title() ?></a> khi bạn sao chép!
        <?php endif ?>
        </span>
      </div>
    </div>
    ...
    <?php if ($this->fields->ShowReward === 'show' || $this->options->ShowGlobalReward === 'show') : ?>
      <div class="post-reward">
        <div class="reward-button button--animated">
          <i class="fas fa-qrcode"></i> Ủng hộ
        </div>
