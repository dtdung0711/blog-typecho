...
<?php if (!$this->page404()) : ?>
  <footer id="footer">
    <div id="footer-wrap">
      <div class="copyright">
        <div class="copyright"><i class="fas fa-copyright"></i> <?php echo date('Y'); ?> <i class="mx-1 animate-pulse fas fa-heart"></i> <?php $this->author(); ?></div>

        <div>
<p class="text-xs pt-2 text-light-500 dark:text-gray-500">Được chỉnh sửa bởi ⭐ <a href="https://www.facebook.com/profile.php?id=100090370753559" target="_blank">Duxng.</a></p>
        </div>
