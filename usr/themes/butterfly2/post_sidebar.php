...
<div class="card-widget card-recent-post">
    <div class="item-headline">
        <i class="fas fa-history"></i><span>Bài viết mới nhất</span>
    </div>
        ...
        <?php while($contents->next()): ?>
            <div class="aside-list-item"> 
                ...
                <div class="content">
                    ...
                    <time datetime="<?php $this->date(); ?>" title="Đăng vào <?php $this->date(); ?>">
                        <?php $contents->date() ?>
                    </time>
                </div>
            </div>
...
<div class="card-widget card-webinfo">
    ...
    <div class="webinfo">
        <div class="webinfo-item">
            <div class="item-name">Số bài viết :</div>
        ...
        <div class="webinfo-item">
            <div class="item-name">Tổng số từ :</div>
            <div class="item-count">
                <?php allOfCharacters(); ?>
            </div>
        </div>
        <?php if ($this->options->ShowOnlinePeople == 'on'): ?>                 
            <div class="webinfo-item">
                <div class="item-name">Số người online hiện tại :</div>
                <div class="item-count" >
                    <?php onlinePeople();?>
                </div>
            </div>
        <?php endif; ?>      
        <div class="webinfo-item">
            <div class="item-name">Tổng lượt truy cập :</div>
            <div class="item-count" >
                <?php theAllViews();?>
            </div>
        </div>
        <div class="webinfo-item">
            <div class="item-name">Thời gian cập nhật lần cuối :</div>
            <div class="item-count" >
                <?php get_last_update(); ?>
            </div>
        </div>
...
<div class="card-widget">
    <div class="item-headline">
        <i class="fas fa-user"></i><span>Người dùng</span>
    </div>
    <div class="widget-list">
        <?php if($this->user->hasLogin()): ?>
        <div class="last"><a href="<?php $this->options->adminUrl(); ?>"><?php _e('Vào bảng điều khiển'); ?> (<?php $this->user->screenName(); ?>)</a></div >
