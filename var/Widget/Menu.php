...
class Menu extends Base
{
    ...
    {
        $parentNodes = [null, _t('Bảng điều khiển'), _t('Viết bài'), _t('Quản lý'), _t('Cài đặt')];

        $childNodes = [
            [
                [_t('Đăng nhập'), _t('Đăng nhập vào%s', $this->options->title), 'login.php', 'visitor'],
                [_t('Đăng ký'), _t('Đăng ký vào%s', $this->options->title), 'register.php', 'visitor']
            ],
            [
                [_t('Tổng quan'), _t('Tổng quan trang web'), 'index.php', 'subscriber'],
                [_t('Cài đặt cá nhân'), _t('Cài đặt cá nhân'), 'profile.php', 'subscriber'],
                [_t('Tiện ích'), _t('Quản lý tiện ích'), 'plugins.php', 'administrator'],
                ...
                [_t('Cài đặt giao diện'), _t('Cài đặt giao diện'), 'options-theme.php', 'administrator', true],
                [_t('Sao lưu'), _t('Sao lưu'), 'backup.php', 'administrator'],
                [_t('Nâng cấp'), _t('Chương trình nâng cấp'), 'upgrade.php', 'administrator', true],
                [_t('Chào mừng'), _t('Chào mừng bạn đến với'), 'welcome.php', 'subscriber', true]
            ],
            [
                [_t('Viết bài'), _t('Viết bài mới'), 'write-post.php', 'contributor'],
            ...
            [
                ...
                [_t('Trang độc lập'), _t('Quản lý trang độc lập'), 'manage-pages.php', 'editor', false, 'write-page.php'],
                ...
                [_t('Thêm mới danh mục'), _t('Thêm mới danh mục'), 'category.php', 'editor', true],
                ...
                [_t('Thêm mới người dùng'), _t('Thêm mới người dùng'), 'user.php', 'administrator', true],
            ...
            [
                ...
                [_t('Liên kết cố định'), _t('Cài đặt liên kết cố định'), 'options-permalink.php', 'administrator'],
            ]
        ];
